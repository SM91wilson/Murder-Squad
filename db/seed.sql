...
('Thank you, I’m sure all of that will be very helpful. One thing that seemed odd as we searched his office were the contents of trash (image) – Since the custodial staff made sure to empty the trash at the end of the day, and he was found at his desk in the morning, the trash can should have been empty. However, there were a few things found inside (could this be the image? Maybe one we can zoom in on?) An empty bottle of ink, a note written in poor handwriting that reads: “Sir – let’s meet tonight. The usual spot for meetings will do. Tell no one. -C.” (when you look at it, you’ll see it’s written on herbology book page that has part of information about a few plants, but White Oleander is one of them, and you read that it has a pleasant smell but consuming the oil can be very poisonous), a small amount of tobacco ash, and a piece of a page of a new copy of his will, as yet to be notarized. If it’s an image leaving the studio to Bruce on the condition that he make it through this job without any issues).
Please examine these closely.
